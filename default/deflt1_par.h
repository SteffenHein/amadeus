...
/* s005=Immunity_half-life_[days]__________________________[0<T]: */  par->s[5]  = 1.80000e+02;
/* s006=Immunization_efficacy_________________[ratio:_0<Ieff<=1]: */  par->s[6]  = 1.00000e+00;
