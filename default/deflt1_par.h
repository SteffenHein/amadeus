...
/* s002=Initially_infective_[acutely_sick]_members_[Ninf][0<Nin]: */  par->s[2]  = 1.00000e+00;
/* s003=Initially_infected_members_[Nifc]___________[Ninf<=Nifc]: */  par->s[3]  = 1.00000e+00;
/* s004=Initially_immune_members__________________________[0<=N]: */  par->s[4]  = 0.00000e+00;
/* s005=Immunity_half-life_[days]__________________________[0<T]: */  par->s[5]  = 1.00000e+99;
/* s006=Immunization_ratio_____________________________[0<Ir<=1]: */  par->s[6]  = 1.00000e+00;
/* s007=Initially_vaccinated_members______________________[0<=N]: */  par->s[7]  = 0.00000e+00;
/* s008=Vaccination_half-life_[days]_______________________[0<T]: */  par->s[8]  = 3.60000e+02;
/* s009=Vaccination_rate_________[vaccinations_per_day;_0<=Nvac]: */  par->s[9]  = 5.00000e+01;
/* s010=Vaccination_efficacy__________________[ratio;_0<Veff<=1]: */  par->s[10] = 8.00000e+01;
/* s011=Initially_deceased_members________________________[0<=N]: */  par->s[11] = 0.00000e+00;
/* s012=Percentage_of_lethal_cases___________________[0<=P<=100]: */  par->s[12] = 2.00000e-03;
/* s013=Initial_reproduction_factor________________________[0<R]: */  par->s[13] = 3.00000e+00;
...
/* s024=Time_limit_[T/days]________________________________[0<T]: */  par->s[24] = 7.30000e+02;
